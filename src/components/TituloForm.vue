        ...
        <form>
            <table class="tableform">
                ...
                <tr>
                    ...
                    <td class="info">
                        <select name="centrodecusto" id="centrodecusto">
                            <option v-for="(centro, index) in $store.state.centrosDeCustos" :key="index" :value="centro.descricao">{{centro.descricao}}</option>
                        </select>
                    </td>
                </tr>
                <tr>
